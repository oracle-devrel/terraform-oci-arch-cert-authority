...
variable "tag_namespace" {
  description = "tag to associate the quickstart solution"
  nullable    = false
  type        = string
}
...
variable "create_new_certificate_authority" {
  default     = true
  description = "Defines whether a new CA should be established"
  type        = bool
  nullable    = false
}
...
variable "create_new_certificate" {
  default     = true
  description = "Defines whether a new certificate should be created from the authority"
  type        = bool
  nullable    = false
}

variable "create_new_certificate_bundle" {
  default     = true
  description = "Defines whether the certificate should be incorporated into a bundle"
  type        = bool
  nullable    = false
}

variable "certificate_authority_ocid" {
  description = "The OCID of the CA if one is to be used"
  default     = ""
  nullable    = true
  type        = string
}
...
variable "certificate_authority_certificate_authority_config_config_type" {
  ...
  description = "Options for values can be found at https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#config_type"
  type        = string
  nullable    = false
}
...
variable "certificate_authority_certificate_authority_config_signing_algorithm" {
  ...
  description = "Name of the algorithm to use when creating the cert - https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#signing_algorithm"
  type        = string
  nullable    = false
}
...
variable "certificate_authority_certificate_authority_config_subject_common_name" {
  default     = "Sample_CA"
  description = "Use is predicated on the config type - moreat https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#common_name"
  type        = string
  nullable    = true
}
...
variable "certificate_authority_certificate_authority_config_subject_country" {
  default     = "IE"
  description = "Value dependent on cert type - https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#country"
  nullable    = true
  type        = string
}
...
variable "certificate_authority_certificate_authority_config_subject_distinguished_name_qualifier" {
  ...
  description = "See https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#distinguished_name_qualifier"
  nullable    = true
  type        = string
}
...
variable "certificate_authority_certificate_authority_config_subject_domain_component" {
  ...
  description = "https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#domain_component"
  nullable    = true
  type        = string
}
...
variable "certificate_authority_certificate_authority_config_subject_generation_qualifier" {
  default     = "Sr."
  description = "String representing generation in a family - https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#generation_qualifier"
  nullable    = true
  type        = string
}
...
variable "certificate_authority_certificate_authority_config_subject_given_name" {
  default     = "Scott Tiger"
  description = "https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#given_name"
  nullable    = false
  type        = string
}
...
variable "certificate_authority_certificate_authority_config_subject_initials" {
  default     = "ST"
  description = "https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#initials"
  type        = string
  nullable    = true
}
...
variable "certificate_authority_certificate_authority_config_subject_locality_name" {
  default     = "Dublin"
  description = "https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#locality_name"
  type        = string
  nullable    = true
}
...
variable "certificate_authority_certificate_authority_config_subject_organization" {
  ...
  description = "https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#organization"
  nullable    = false
  type        = string
}
...
variable "certificate_authority_certificate_authority_config_subject_organizational_unit" {
  default     = "R&D"
  description = "https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#organizational_unit"
  nullable    = false
  type        = string
}
...
variable "certificate_authority_certificate_authority_config_subject_pseudonym" {
  default     = "pseudonym"
  description = "https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#pseudonym"
  nullable    = true
  type        = string
}

variable "certificate_authority_certificate_authority_config_subject_serial_number" {
  description = "https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/certificates_management_certificate_authority#serial_number"
...
variable "certificate_certificate_config_rsa_bits" {
  default = 2048
}
...
variable "certificate_description" {
  default  = "generic certificate using defaulted values"
  type     = string
  nullable = false
}
